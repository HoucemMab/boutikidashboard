...
const ECommerceDashboard = () => {
  return (
    <PageContainer heading="Boutiki Dashboard" breadcrumbs={breadcrumbs}>
      <GridContainer>
        ...
        <iframe
          src="http://localhost:5601/app/dashboards#/view/f9ba8620-deae-11ed-a1b8-c12c3c9e8185?embed=true&_g=(refreshInterval:(pause:!t,value:60000),time:(from:now-15m,to:now))&_a=()"
          height="600"
          width="1000"></iframe>
      </GridContainer>
    </PageContainer>
